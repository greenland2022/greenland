...
if(isset($_GET['id'])){
    ...
    $queryCart="SELECT * FROM medical_plant WHERE plants_id={$_GET['idAdd']}";
        ...
        <div class="single_product_desc clearfix">
            ...
            <form>
                ...
                <div class="cart-fav-box d-flex align-items-center">
                    <!-- Cart -->
                    <?php 
                               echo "<a href='singleMedical-product-details.php?idAdd={$plant['plants_id']}' class='btn essence-btn'>Add To Cart</a>";
?>
