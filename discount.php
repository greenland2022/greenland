                ...
                <div class="col-12 col-md-8 col-lg-9">
                    <div class="shop_grid_product_area">
                        <div class="row">
                            ...
                            $countpro=0;
                            while($product=mysqli_fetch_assoc($result2)){$countpro++ ;}
                            echo $countpro;?>
...
?>
                            ...
                            while($product=mysqli_fetch_assoc($result2)){
                                ...
                                echo "<a href='single-product-details.php?id={$product['id']}'>";
                ...
                $dicount=$num*.4;
                                ...
                                echo "<a href='discount.php?id={$product['id']}' type='submit' name='add' class='btn essence-btn'>Add to Cart</a>";
                                echo "</div>";
                                echo "</div>";
                                echo "</div>";
                                echo "</div>";
