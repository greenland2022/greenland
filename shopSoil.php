...
while($soil=mysqli_fetch_assoc($result)){
  ...
  echo "<div class='product-img'>";
         ...
         echo "<div class='product-description'>";
           ...
           echo "<a href='singleSoil-product-details.php?id={$soil['soil_id']}'>";
           echo   "<span>{$soil['description']}</span>";
           echo '</a>';
           echo "<p class='product-price'><span class='old-price'>{$soil['price']}</span>";
                 
                  echo ' </p>';
                  echo "<div class='hover-content'>";
                  echo '<div class="add-to-cart-btn">';
                  echo "<a href='shopSoil.php?id={$soil['soil_id']}' class='btn essence-btn'>Add to Cart</a> ";
                  echo "</div>";
                  echo "</div>";
                  echo "</div>";
                  echo "</div>";
