                    ...
                    <div class="shop_grid_product_area">
                        ...
                        <?php
                            ...
                            while($soil=mysqli_fetch_assoc($result2)){
                                ...
                                echo "<a href='single-product-details.php?id={$soil['soil_id']}'>";
                                ...
                                echo "<a href='shopSoil.php?id={$soil['soil_id']}' type='submit' name='add' class='btn essence-btn'>Add to Cart</a>";
                                echo "</div>";
                                echo "</div>";
                                echo "</div>";
                                echo "</div>";
