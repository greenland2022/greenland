...
if(isset($_POST['submit'])){
    ...
    $price=$_POST['price'];
    $query="INSERT INTO flowers (name,img,imgTwo,price,description) VALUES ('$catName','$catImg','$imgTwo','$price','$description') ";
    ...
    $price=$_POST['price'];
        ...
        $query="UPDATE flowers SET name='$catName',
        img='$catImg'  ,
        imgTwo='$imgTwo',
        price='$price' ,
        ...
        if(isset($_GET['id'])){
            $query="SELECT * FROM flowers WHERE id={$_GET['id']}";
            $result=mysqli_query($conn,$query);
            $cat=mysqli_fetch_assoc($result);
        }
        if(isset($_GET['id1'])){
            $query="DELETE FROM flowers WHERE id={$_GET['id1']}";
            mysqli_query($conn,$query);
        }
?>
                                    ...
                                    <table class="table table-borderless table-striped table-earning">
                                        ...
                                        <?php
                                            ...
                                            while($category=mysqli_fetch_assoc($result)){
                                                ...
                                                echo "<td><a href='manageflowers.php?id={$category['id']}'>Edit</a> </td>";
                                                echo "<td><a href='manageflowers.php?id1={$category['id']}'>Delete</a> </td>";
                                            echo "</tr>";
                                            }
                                            ?>
