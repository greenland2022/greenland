...
if(isset($_POST['submit'])){
    ...
    $price=$_POST['price'];
    $query="INSERT INTO medical_plant (plant_name,plant_img,plant_img_two,price,description) VALUES ('$catName','$catImg','$imgTwo','$price','$description') ";
    mysqli_query($conn,$query);
    header("Location:manageMedicalPlants.php");
    ...
    $price=$_POST['price'];
        ...
        $query="UPDATE medical_plant SET plant_name='$catName',
        plant_img='$catImg'  ,
        plant_img_two='$imgTwo',
        price='$price' ,
        ...
        if(isset($_GET['id1'])){
            $query="DELETE FROM medical_plant WHERE plants_id={$_GET['id1']}";
            mysqli_query($conn,$query);
        }
?>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <div class="input-group">
                                                    <input type="file" id="image" name="image" placeholder="Category Image" value="<?php if(isset($_GET['id'])){echo $catName;}?><images/<?php echo $cat['plant_img'];?>>" class="form-control">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="input-group">
      ...
      <div class="col-lg-9">
                                <div class="table-responsive table--no-card m-b-30">
                                    <table class="table table-borderless table-striped table-earning">
                                        ...
                                        <tbody>
                                        <?php
                                            $query="SELECT * FROM medical_plant ";
                                            $result=mysqli_query($conn,$query);
                                            while($category=mysqli_fetch_assoc($result)){
                                                ...
                                                echo "<td><img src='images/{$category['plant_img_two']}' width='100px' height='100px'/> </td>";
                                                echo "<td>{$category['description']} </td>";
                                                echo "<td>{$category['price']} </td>";
                                                echo "<td><a href='manageMedicalPlants.php?id={$category['plants_id']}'>Edit</a> </td>";
                                                echo "<td><a href='manageMedicalPlants.php?id1={$category['plants_id']}'>Delete</a> </td>";
                                            echo "</tr>";
                                            }
                                            ?>
