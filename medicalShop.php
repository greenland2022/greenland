...
?>
                            ...
                            while($plants=mysqli_fetch_assoc($result2)){
                                ...
                                echo "<img class='hover-img' src='admin/images/{$plants['plant_img_two']}' alt=''>";
                                ...
                                echo "<a href='singleMedical-product-details.php?id={$plants['plants_id']}'>";
                                ...
                                echo "<a href='medicalShop.php?id={$plants['plants_id']}' type='submit' name='add' class='btn essence-btn'>Add to Cart</a>";
                                echo "</div>";
                                echo "</div>";
                                echo "</div>";
                                echo "</div>";
